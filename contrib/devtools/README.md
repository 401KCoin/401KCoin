...
Setup
---------
Configuring the github-merge tool for the 401K Coin repository is done in the following way:

    git config githubmerge.repository 401kcoin/401kcoin
...
A script to optimize png files in the 401K Coin
