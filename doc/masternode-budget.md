...
401K Coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ 401K, _12_ times over the course of a year totaling _24000_ 401K.
...
When block `1000000` is reached you'll receive a payment for `1200` 401K.
