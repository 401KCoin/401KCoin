...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("401K Coin Core 401kcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  401kcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded 401K Coin transaction") + "\n" +
                               "  401kcoin-tx [options] -create [commands]   " + _("Create hex-encoded 401K Coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded 401K Coin transaction
