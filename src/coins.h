...
/** 
    ...
    ****Note - for 401K Coin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of 401K Coin coming in to a transaction
